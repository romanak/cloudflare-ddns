...
api_token="FErsdfklw3er59dUlDce44-3D43dsfs3sddsFoD3"
    ...
    then
        ...
        then
            ...
            then
                ...
                | jq -r '.errors'
                # write the result
                echo -e "\033[0;32m [+] The IPv4 record on Cloudflare was successfully updated from $dns_record_a_ip to $ipv4"
            else
        ...
        then
            ...
            then
                ...
                | jq -r '.errors'
                # write the result
                echo -e "\033[0;32m [+] The IPv6 record on Cloudflare was successfully updated from $dns_record_aaaa_ip to $ipv6"
            else
...
# chmod +x ./sync.sh
# crontab -e
# */15 * * * * /home/pi/scripts/cloudflare-ddns/sync.sh